        ...
        if (METAS && METAS.hasOwnProperty('doi') && METAS.doi) {
            ...
            getRisFromOriginSite(METAS).then((ris) => {
                ...
                .finally(() => {
                    ...
                    // render
                    // 修订RIS信息显示不正确的插件函数
                    RIS = information_fix_plugin(RIS)
                    console.log('RIS:\n', RIS);
                    console.log('Final metas:', METAS);
...
// RIS信息修复函数
function information_fix_plugin(data){
    var fix_information = [['T2  - Environmental Science &amp; Technology','T2  - Environmental Science & Technology']];
    for (var i of fix_information){
